      ...
      <p><b>Note:</b> If the Media Title is not filled, the default media title {<strong>Zoom recording date:(date)</strong>} will be used.</p>
        ...
        <div class="card mt-2">
          <div class="card-header">
            ...
            <div class="card-body">
            <p class="card-text">Please visit UR Courses Instuctor guides on <a href="https://urcourses.uregina.ca/guides/instructor/h5p#zoom-importer" target="_blank">how to import zoom url recordings in Kaltura using mymedia tool</a>.</p>
            </div>
        </div>
  </div>
