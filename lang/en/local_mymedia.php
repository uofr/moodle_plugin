...
$string['showvideos'] = 'Load media recordings';
$string['troubleuploading'] = 'Trouble uploading?';
$string['urlsforh5p'] = 'URLs for H5P';
$string['importzoomrecordings'] = 'Import Zoom Recordings';
$string['logs'] = 'Logs';
