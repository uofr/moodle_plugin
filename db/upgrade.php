...
function xmldb_local_kaltura_upgrade($oldversion) {
    ...
    if ($oldversion < 2026031200) {
        ...
        $table->add_field('clip_id', XMLDB_TYPE_CHAR, '50', null, XMLDB_NOTNULL, null, null);
        ...
        $table->add_key('clip_id_unique', XMLDB_KEY_UNIQUE, ['clip_id', 'id']);
        ...
        upgrade_plugin_savepoint(true, 2026031200, 'local', 'kaltura');
    }
	
    if ($oldversion < 2026031202) {
        
        $table = new xmldb_table('ur_kaltura_zoom');
        $field = new xmldb_field('categories', XMLDB_TYPE_TEXT, 'medium', null, null, null, null, 'tags');
