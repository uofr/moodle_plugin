  ...
  <div class="container-fluid mb-2">
    <div class="card mt-2">
      ...
      <div class="card-body">
        <div class="row">
          <p class="text"></p>
          <form  class= "col-md-6" name="getfirstload" method="post" action="get_zoom_clips.php">
...
if (isset($_POST['datefrom']) && isset($_POST['dateto'])) {
	...
	error_log('ZVM: check dates');
    foreach ($period as $xcount => $dateval) {
        $countdate = $dateval->format("Y-m-d");
        $getrecordings = $get_recording_service->get_user_clips_list($zoomMails, $datefrom, $countdate);
		$data = $getrecordings; 
		error_log('ZVM: data =>'.print_r($data,1));
