...
$PAGE->set_url('/local/mymedia/get_zoom_videos.php');
  ...
  <div class="container-fluid mb-2">
    <div class="card mt-2">
      ...
      <div class="card-body">
        <div class="row">
          <p class="text"></p>
          <form  class= "col-md-6" name="getfirstload" method="post" action="get_zoom_videos.php">
...
if (isset($_POST['datefrom']) && isset($_POST['dateto'])) {
    ...
    foreach ($period as $xcount => $dateval) {
        ...
        $getrecordings = $get_recording_service->get_user_videos_list($zoomMails, $datefrom, $countdate);
